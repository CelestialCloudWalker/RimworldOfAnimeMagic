...
{
    public class BreathingPotentialGene : Gene_TalentBase
    {
        new BreathingPotentialGeneDef Def => (BreathingPotentialGeneDef)def;
        ...
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            {
                string resourceLabel = !string.IsNullOrEmpty(Def?.resourceLabel) ? Def.resourceLabel : "Potential";
